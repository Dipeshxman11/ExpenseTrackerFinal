...
async function addExpense() {
    try {
        ...
        const res = await axios
            .post("http://localhost:3001/expense/addExpense", {
                date: dateStr,
...
async function getAllExpenses() {
    // e.preventDefault();
    try {
        const res = await axios.get("http://localhost:3001/expense/getAllExpenses");
                ...
                if (expense.id == id) {
                    ...
                    addExpenseBtn.addEventListener("click", async function update(e) {
                        ...
                        const res = await axios.post(
                            `http://localhost:3001/expense/editExpense/${id}`,
                            {
